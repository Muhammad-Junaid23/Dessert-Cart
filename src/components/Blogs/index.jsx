    ...
    <Box width={'100%'} minHeight={'80vh'}>
      ...
      <Stack direction={'row'} spacing={3} ml={2} mb={2}>
        <Card sx={{ maxWidth: 345 }}>
          ...
          />
          <CardMedia component='img' height='194' image='/img/image-cake-thumbnail.jpg' alt='Paella dish' />
          <CardContent>
          ...
          <Collapse in={expanded} timeout='auto' unmountOnExit>
            <CardContent>
              ...
              <Typography sx={{ marginBottom: 2 }}>
                ...
                and cook, stirring occasionally until lightly browned, 6 to 8 minutes. Transfer shrimp to a large plate and set aside,
                leaving chicken and chorizo in the pan. Add pimentón, bay leaves, garlic, tomatoes, onion, salt and pepper, and cook,
                stirring often until thickened and fragrant, about 10 minutes. Add saffron broth and remaining 4 1/2 cups chicken broth;
                bring to a boil.
              </Typography>
              <Typography sx={{ marginBottom: 2 }}>
        ...
        <Card sx={{ maxWidth: 345 }}>
          ...
          />
          <CardMedia component='img' height='194' image='/img/image-meringue-desktop.jpg' alt='Paella dish' />
          <CardContent>
            <Typography variant='body2' sx={{ color: 'text.secondary' }}>
              This hall midway down the road is a perfect party dish and a fun meal to cook together with your guests. Add 1 cup of frozen
